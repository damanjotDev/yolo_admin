...
import { AdminReducer, CategoryReducer, EventReducer, PropertyReducer, ServiceReducer, TagReducer, UserReducer } from "./reducers";
...
const persistConfig = {
  key: 'root',
  storage: storage,
  whitelist: ['Admin', 'Service', 'Property', 'User', 'Category', 'Event']
